...
class CLIPSegForImageSegmentation(CLIPSegPreTrainedModel):
    ...
    def forward(
        ...
        if conditional_embeddings.shape[0] == 1 :
            conditional_embeddings = conditional_embeddings.repeat(pixel_values.shape[0], 1)  # [1, 512] -> [B, 512]
        elif conditional_embeddings.shape[0] == pixel_values.shape[0]: # equal size
            pass
        else:
            raise ValueError("len of text must be equal with image shape or equal with 1")
